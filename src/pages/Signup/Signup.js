    ...
    <div className="w-full mx-auto my-16 bg-yellow-100 max-w-md p-8 space-y-3 rounded-xl dark:dark:bg-gray-900 dark:dark:text-gray-100">
      ...
      >
        <div className="space-y-1 text-sm">
          <label for="name" className="block dark:dark:text-gray-400">
            Name:
          </label>
          <input
            type="text"
            ...
            id="name"
            placeholder="Name"
            className="w-full px-4 py-3 rounded-md dark:dark:border-gray-700 dark:dark:bg-gray-900 dark:dark:text-gray-100 focus:dark:dark:border-sky-400"
          />
        </div>
        <div className="space-y-1 text-sm">
        ...
        <div className="space-y-1 text-sm">
          <label for="password" className="block dark:dark:text-gray-400">
            Password
          </label>
          <input
            type="password"
