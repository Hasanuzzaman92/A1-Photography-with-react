              ...
              {user?.uid ? (
                <>
                  <Link
                    ...
                    aria-label="service"
                    title="service"
                    className="font-medium mr-6 tracking-wide text-gray-100 transition-colors duration-200 hover:text-teal-accent-400"
                  >
                    Services
                  </Link>
            ...
            <li>
              {user?.uid ? (
                ...
                <>
                  <Link
                    to="/login"
                    className="inline-flex mr-5 items-center justify-center h-12  font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-deep-purple-accent-400 hover:bg-deep-purple-accent-700 focus:shadow-outline focus:outline-none"
                    aria-label="log in"
                    title="Log in"
                  >
                    Login
