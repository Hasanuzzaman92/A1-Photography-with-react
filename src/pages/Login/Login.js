...
const Login = () => {
	...
	<form novalidate="" action="" className="space-y-6 ng-untouched ng-pristine ng-valid">
		<div className="space-y-1 text-sm">
			...
			<input type="text" name="email" id="email" placeholder="Email" className="w-full px-4 py-3 rounded-md dark:dark:border-gray-700 dark:dark:bg-gray-900 dark:dark:text-gray-100 focus:dark:dark:border-sky-400" />
		</div>
		<div className="space-y-1 text-sm">
	...
	<p className="text-sm text-center sm:px-6 dark:dark:text-gray-400">Don't have an account? {' '}
		<Link rel="noopener noreferrer" to="/signup" className="underline dark:dark:text-gray-100">Sign up</Link>
	</p>
</div>
    );
};
